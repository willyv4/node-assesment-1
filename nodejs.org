...
<head>
  ...
  <title>Console | Node.js v20.0.0 Documentation</title>
...
<p><strong>Source Code:</strong> <a href="https://github.com/nodejs/node/blob/v20.0.0/lib/console.js">lib/console.js</a></p>
...
<pre><code class="language-js"><span class="hljs-keyword">const</span> { <span class="hljs-title class_">Console</span> } = <span class="hljs-built_in">require</span>(<span class="hljs-string">'node:console'</span>);</code> <button class="copy-button">copy</button></pre>
